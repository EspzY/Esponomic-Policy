...
export const curatedPracticeProblems: PracticeProblem[] = [
  practiceProblem({
    ...
    solutionOutline: [
      ...
      "A strong answer earns its clarity by following the same order each time: benchmark object first, actual-versus-natural comparison second, sign logic third.",
    ],
    answerPlaceholder:
