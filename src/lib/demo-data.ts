...
export const demoQuizItems: QuizItem[] = [
  ...
  },
  {
    id: "lecture2-quiz-2",
    prompt:
      "What is the cleanest interpretation of θ in the Lecture 2 firm block?",
    choices: [
